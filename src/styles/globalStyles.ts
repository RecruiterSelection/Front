...
export const GlobalStyle = createGlobalStyle`
    ...
    :root{
        ...
        --feedback--sucess-1: rgba(24, 121, 78, 1);
        ...
        --random--random7: rgba(52, 153, 116, 1);
        --random--random8: rgba(42, 125, 95, 1);
        --random--random9: rgba(21, 61, 46, 1);
        --random--random10: rgba(97, 0, 255, 1);
        ...
        --text--body6: 1.25rem; //20px
        --text--body7: 4rem; //64px
